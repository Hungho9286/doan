                ...
                case 5:
                  {
                    if (u.point >= 5) {
                      ...
                      user.update({'ChaoPoint': u.point - 5});
                      setState(() {
                        u.point = u.point - 5;
                      });
                    }
                ...
                case 25:
                  {
                    if (u.point >= 25) {
                      Inventories_object inVent = new Inventories_object(
                          ...
                          amount: 1);
                      inventories.add(inVent.toJson());
                      user.update({'ChaoPoint': u.point - 25});
                      setState(() {
                        u.point = u.point - 25;
                      });
                    }
                ...
                case 45:
                  {
                    if (u.point >= 45) {
                      Inventories_object inVent = new Inventories_object(
                          ...
                          amount: 1);
                      inventories.add(inVent.toJson());
                      user.update({'ChaoPoint': u.point - 45});
                      setState(() {
                        u.point = u.point - 45;
                      });
                    }
                ...
                case 100:
                  {
                    if (u.point >= 100) {
                      Inventories_object inVent = new Inventories_object(
                          ...
                          amount: 1);
                      inventories.add(inVent.toJson());
                      user.update({'ChaoPoint': u.point - 100});
                      setState(() {
                        u.point = u.point - 100;
                      });
                    }
                ...
                case 250:
                  {
                    if (u.point >= 250) {
                      Inventories_object inVent = new Inventories_object(
                          ...
                          amount: 1);
                      inventories.add(inVent.toJson());
                      user.update({'ChaoPoint': u.point - 250});
                      setState(() {
                        u.point = u.point - 250;
                      });
                    }
