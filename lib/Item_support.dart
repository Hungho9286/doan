                ...
                case 30:
                  {
                    if (u.pointChao >= 30) {
                      ...
                      user.update({'ChaoPoint': u.pointChao - 30});
                      setState(() {
                        u.pointChao = u.pointChao - 30;
                      });
                    }
                  }
                  break;
                case 40:
                  {
                    if (u.pointChao >= 40) {
                      Inventories_object inVent = new Inventories_object(
                          ...
                          amount: 1);
                      inventories.add(inVent.toJson());
                      user.update({'ChaoPoint': u.pointChao - 40});
                      setState(() {
                        u.pointChao = u.pointChao - 40;
                      });
                    }
                  }
                  break;
                case 50:
                  {
                    if (u.pointChao >= 50) {
                      Inventories_object inVent = new Inventories_object(
                          ...
                          amount: 1);
                      inventories.add(inVent.toJson());
                      user.update({'ChaoPoint': u.pointChao - 50});
                      setState(() {
                        u.pointChao = u.pointChao - 50;
                      });
                    }
                  }
                  break;
                case 80:
                  {
                    if (u.pointChao >= 80) {
                      Inventories_object inVent = new Inventories_object(
                          ...
                          amount: 1);
                      inventories.add(inVent.toJson());
                      user.update({'ChaoPoint': u.pointChao - 80});
                      setState(() {
                        u.pointChao = u.pointChao - 80;
                      });
                    }
                  }
                  break;
